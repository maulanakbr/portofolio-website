...
const ProjectCard = ({
  ...
  return (
    <section className="mx-auto mb-8 flex w-[65vw] flex-wrap items-center justify-center overflow-hidden rounded-xl bg-primary-400 shadow-lg outline outline-2 outline-offset-4 md:mb-4 lg:mx-0 lg:h-[72vh] lg:w-[25vw] hover:lg:h-[90vh]">
      <div className="h-full w-full flex-col">
        <div className="group relative mb-4 h-[40vh] overflow-hidden hover:h-[65vh] lg:h-[50vh]">
          ...
          <div className="absolute top-0 flex h-full w-full items-center justify-center bg-primary-600 group-hover:hidden">
            <div className="relative h-[11rem] w-[11rem] rounded-full border xl:h-[15rem] xl:w-[15rem]">
              <span className="absolute bottom-6 -left-5 text-[80px] font-semibold text-primary-200 group-hover:hidden xl:-left-8 xl:text-[120px]">{`0${projectId}`}</span>
            </div>
          </div>
        </div>
        <a href={webUrl} aria-label={name} target="blank" rel="noreferrer">
