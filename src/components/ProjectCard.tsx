...
const ProjectCard = ({
  ...
  return (
    <section className="mx-auto mb-8 flex w-[75vw] flex-wrap items-center justify-center overflow-hidden rounded-xl bg-primary-400 shadow-lg outline outline-2 outline-offset-4 sm:w-[80vw] md:w-[78vw] lg:mx-0 lg:mb-4 lg:h-[72vh] lg:w-[20vw] hover:lg:h-[90vh] xl:w-[24vw]">
