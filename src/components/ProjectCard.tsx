...
const ProjectCard = ({
  ...
  return (
    <section className="mx-auto mb-8 flex w-[73vw] flex-wrap items-center justify-center overflow-hidden rounded-xl bg-primary-400 shadow-lg outline outline-2 outline-offset-4 sm:w-[52vw] md:mb-4 lg:mx-0 lg:h-[72vh] lg:w-[35vw] hover:lg:h-[90vh] xl:w-[24vw]">
